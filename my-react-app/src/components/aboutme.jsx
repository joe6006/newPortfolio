...
const RenderAboutMe = ({ handleClick }) => {
        ...
        <section>
            ...
            <div className="aboutme-background">
                ...
                <div className='aboutme-container'>
                    ...
                    <p>
                        Hey there! I'm a software developer in training, currently making the leap into tech after working in a different field. It's been an exciting journey full of learning and growth.
                    ...
                    <div className="education">
                        ...
                        <ul>
                            ...
                            <li>Started learning Python, familiar with JS and C++ [10%]</li>
